========================================================================
    KONSOLENANWENDUNG: TypeImageClassTesterVC12-Projektübersicht
========================================================================

Diese TypeImageClassTesterVC12-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre TypeImageClassTesterVC12-Anwendung besteht.


TypeImageClassTesterVC12.vcxproj
...
TypeImageClassTesterVC12.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen TypeImageClassTesterVC12.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
